...
const Navibar: React.FC = () => {
  ...
  return (
    <div className="w-full sticky z-50 -top-[1.5rem] cmd:block hidden bg-cover bg-top bg-hero-gradient">
      <ComponentWrapper>
        <div className="w-full pt-5 pb-5 csm2:pt-10 grid grid-cols-[1.5fr,1fr] csm:grid-cols-2 cmd:grid-cols-3 gap-2 csm:gap-4">
          {/* 1st col  */}
          ...
          <div className="w-full order-2 cmd:order-3 flex justify-end csm2:justify-center items-center gap-2">
            <div className="w-[90px] csm2:block hidden h-[100px]">
            <img src={certificateLogo} alt="Certificate" className="w-full h-full" />
            </div>
            <div className="w-[90px] h-[100px] csm2:block hidden">
        ...
        {/* navigations -------> */}
        {/* <div className="w-full py-2 csm:py-3 grid grid-cols-4 justify-center items-center">
          {navigationButtons.map((item, index) => {
            return (
              ...
              >
                <div className="flex justify-center items-center gap-1 csm:gap-2">
                  {selectedBtn === item && (
                    <Icons.LeftArrow
                      className="text-[12px] csm:w-[14px] rotate-180 h-[12px]"
                      fill="fill-[#ff9527]"
                    />
                  )}
                  {item}
