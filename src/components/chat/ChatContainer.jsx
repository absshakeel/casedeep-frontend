...
// Only fetch messages if both senderId and receipientId are available
if (senderId && receipientId) {
try {
...
// If user is not logged in or no recipient is selected
setMessages([]);
}
};
fetchMessages();
}, [chattingWith, sent, senderId, receipientId]);
